...
if (versionBeta == true) {
    ...
    if (footer) {
        footer.innerHTML = '<a href="https://www.enfermeriaenaccion.com.ar/" style="color: #667eea; text-decoration: none;">Ir a la versión estable del sistema.</a>' + '<br>' + '<span style="color: #ff6b6b; font-weight: bold;">Versión:</span> 3.5.13';
    ...
    const footer = document.querySelector('footer');
    if (footer) {
        footer.innerHTML = '<a href="https://aula-enfermeria-beta.vercel.app/index.html" style="color: #667eea; text-decoration: none;">Ir a la versión BETA del sistema.</a>' + '<br>' + '<span style="color: #2d5a5a; font-weight: bold;">Versión:</span> 3.5';
    }
}
